...
# Answer:
#   The variable `limit` is initialized in outer scope, which is not accessible within the method definition.
#   The limit should either be initialized within the method def scope or be passed in as an argument.
